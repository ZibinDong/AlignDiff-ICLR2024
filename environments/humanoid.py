...
#     def __init__(
#         self,
#         xml_file=path.join(path.abspath(path.dirname(__file__)), "assets/humanoid.xml"),
...
#         observation_space = Box(
#             low=-np.inf, high=np.inf, shape=(270,), dtype=np.float64)
